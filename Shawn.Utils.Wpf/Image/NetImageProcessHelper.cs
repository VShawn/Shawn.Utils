...
namespace Shawn.Utils.Wpf.Image
{
    public static class NetImageProcessHelper
    {
        ...
        public static System.Drawing.Image ToThumbnail(this Bitmap image, int width, int height)
        {
        ...
        {
            return source?.ToBitmap()?.ToBytes() ?? new byte[] { };
        }
        ...
        public static Icon ToIcon(this System.Drawing.Image img)
        {
        ...
        {
            return (BitmapSource)ToBitmapImage(image);
        }

        public static System.Drawing.Image ImageFromBytes(byte[] byteArrayIn)
        {
            using var mStream = new MemoryStream(byteArrayIn);
            return System.Drawing.Image.FromStream(mStream);
        }

        public static System.Drawing.Image ToImage(this Bitmap src)
        {
            using var ms = new MemoryStream();
